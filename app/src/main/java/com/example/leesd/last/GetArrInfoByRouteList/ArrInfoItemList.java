...
public class ArrInfoItemList {
    ...
    {
        return "ClassPojo [nmainSec1 = "+nmainSec1+", reride_Num1 = "+reride_Num1+", nstnSec1 = "+nstnSec1+", nmainSec2 = "+nmainSec2+", sectOrd1 = "+sectOrd1+", arrmsg1 = "+arrmsg1+", nmain2Ord2 = "+nmain2Ord2+", arrmsg2 = "+arrmsg2+", sectOrd2 = "+sectOrd2+", nmain2Ord1 = "+nmain2Ord1+", nmainOrd1 = "+nmainOrd1+", isArrive1 = "+isArrive1+", nmainOrd2 = "+nmainOrd2+", expCf1 = "+expCf1+", isArrive2 = "+isArrive2+", expCf2 = "+expCf2+", stNm = "+stNm+", brerde_Div1 = "+brerde_Div1+", kals2 = "+kals2+", brerde_Div2 = "+brerde_Div2+", kals1 = "+kals1+", busRouteId = "+busRouteId+", nstnOrd2 = "+nstnOrd2+", rtNm = "+rtNm+", nmain2Stnid1 = "+nmain2Stnid1+", nmain2Stnid2 = "+nmain2Stnid2+", vehId2 = "+vehId2+", plainNo2 = "+plainNo2+", plainNo1 = "+plainNo1+", nstnSec2 = "+nstnSec2+", nmain3Ord2 = "+nmain3Ord2+", vehId1 = "+vehId1+", nmain3Ord1 = "+nmain3Ord1+", reride_Num2 = "+reride_Num2+", busType1 = "+busType1+", nstnOrd1 = "+nstnOrd1+", busType2 = "+busType2+", firstTm = "+firstTm+", brdrde_Num1 = "+brdrde_Num1+", neuCf1 = "+neuCf1+", neuCf2 = "+neuCf2+", stId = "+stId+", nmain3Stnid2 = "+nmain3Stnid2+", brdrde_Num2 = "+brdrde_Num2+", nmain3Stnid1 = "+nmain3Stnid1+", avgCf1 = "+avgCf1+", avgCf2 = "+avgCf2+", goal2 = "+goal2+", goal1 = "+goal1+", traSpd1 = "+traSpd1+", traSpd2 = "+traSpd2+", nstnSpd1 = "+nstnSpd1+", nstnSpd2 = "+nstnSpd2+", full2 = "+full2+", full1 = "+full1+", routeType = "+routeType+", dir = "+dir+", lastTm = "+lastTm+", traTime2 = "+traTime2+", staOrd = "+staOrd+", nmain3Sec1 = "+nmain3Sec1+", nmain3Sec2 = "+nmain3Sec2+", traTime1 = "+traTime1+", stationNm1 = "+stationNm1+", stationNm2 = "+stationNm2+", namin2Sec2 = "+namin2Sec2+", exps1 = "+exps1+", exps2 = "+exps2+", namin2Sec1 = "+namin2Sec1+", nmainStnid1 = "+nmainStnid1+", nmainStnid2 = "+nmainStnid2+", mkTm = "+mkTm+", nextBus = "+nextBus+", neus1 = "+neus1+", neus2 = "+neus2+", arsId = "+arsId+", rerdie_Div2 = "+rerdie_Div2+", rerdie_Div1 = "+rerdie_Div1+", kalCf1 = "+kalCf1+", nstnId1 = "+nstnId1+", kalCf2 = "+kalCf2+", isLast1 = "+isLast1+", term = "+term+", isLast2 = "+isLast2+", nstnId2 = "+nstnId2+"]";
    }
}
