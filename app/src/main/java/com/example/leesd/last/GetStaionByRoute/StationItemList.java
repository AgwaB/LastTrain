...
public class StationItemList {
    ...
    {
        return "ClassPojo [posY = "+posY+", posX = "+posX+", traSpd1 = "+traSpd1+", traSpd2 = "+traSpd2+", rerdieDiv1 = "+rerdieDiv1+", stationTp = "+stationTp+", nxtStn = "+nxtStn+", rerdieDiv2 = "+rerdieDiv2+", sectNm = "+sectNm+", adirection = "+adirection+", arrmsg1 = "+arrmsg1+", sectOrd1 = "+sectOrd1+", arrmsg2 = "+arrmsg2+", routeType = "+routeType+", gpsX = "+gpsX+", gpsY = "+gpsY+", sectOrd2 = "+sectOrd2+", isArrive1 = "+isArrive1+", isArrive2 = "+isArrive2+", lastTm = "+lastTm+", stNm = "+stNm+", traTime2 = "+traTime2+", staOrd = "+staOrd+", traTime1 = "+traTime1+", stationNm1 = "+stationNm1+", stationNm2 = "+stationNm2+", arrmsgSec2 = "+arrmsgSec2+", busRouteId = "+busRouteId+", arrmsgSec1 = "+arrmsgSec1+", nextBus = "+nextBus+", rtNm = "+rtNm+", arsId = "+arsId+", isFullFlag1 = "+isFullFlag1+", vehId2 = "+vehId2+", isFullFlag2 = "+isFullFlag2+", rerideNum2 = "+rerideNum2+", rerideNum1 = "+rerideNum1+", vehId1 = "+vehId1+", isLast1 = "+isLast1+", term = "+term+", isLast2 = "+isLast2+", busType1 = "+busType1+", busType2 = "+busType2+", firstTm = "+firstTm+", stId = "+stId+"]";
    }
}
